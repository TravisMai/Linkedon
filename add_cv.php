        ...
        <div class="row">
            ...
            <div class="col-7 col-sm-10 col-md-5">
                <ul class="nav nav-tabs flex-column flex-md-row small" id="cv-Tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="certification-tab"
                            onclick="changeTab('certification')">Certification</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="card-body tab-content">
                            ...
                            <div class="tab-pane active" id="personal-section">
                                ...
                                <input type="text" class="form-control" name="last-name"
                                    placeholder="Tell us the field you want to apply" id="last-name" required disabled
                                    value="lấy bên login">
                                ...
                                <input type="textarea" class="form-control"
                                    placeholder="Tell us something about your habit and hobby">
                            ...
                            <div class="tab-pane" id="objective-section">
                                ...
                                <form>
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <input
                                            placeholder="Tell us the position you want to apply: fresher, junior, etc.."
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <input placeholder="Ex: 20.000.000VNĐ" type="text" class="form-control"
                                            id="salary-range" name="salary-range">
                                    </div>
                                    <div class="form-group mt-1">
                                        <label for="qualifications">Qualifications and Career Goals</label>
                                        <textarea
                                            placeholder="Tell us about your aim and goal, and expectation about job"
                                            class="form-control" id="qualifications" name="qualifications"
                                            rows="2"></textarea>
                                    </div>
                                    <div class="d-flex justify-content-between mt-4">
                            ...
                            <div class="tab-pane" id="education-section">
                                ...
                                <form>
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <input type="number" min="1990" max="2035" class="form-control"
                                            id="graduation-year" placeholder="2024" name="graduation-year">
                                    </div>
                                    <div class="form-group mt-1">
                                        <label for="gpa">GPA</label>
                                        <div class="d-flex align-items-center">
                                            <input type="number" step="0.01" min="1" max="10" class="form-control mr-2"
                                                id="gpa-value" placeholder="7.0" name="gpa-value">
                                ...
                                <form>
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <input type="text" class="form-control"
                                            placeholder="What you obtain after working at this position"
                                ...
                                <form>
                                    ...
                                    <div class="form-group mt-1 ">
                                        ...
                                        <textarea class="form-control" id="job-description"
                                            ...
                                            name="job-description" rows="5" required></textarea>
                                    </div>
                                </form>
                                <div class="d-flex justify-content-between mt-4">
                            ...
                            <div class="tab-pane" id="certification-section" style="display: none;">
                                ...
                                <form>
                                    <div class="form-group mt-1">
                                        ...
                                        <input type="text" class="form-control" placeholder="Certification title"
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <textarea class="form-control" name="certification-description[]" rows="5"
                                            required></textarea>
                                    </div>
                                </form>
                            ...
                            <div class="tab-pane" id="reference-section" style="display: none;">
                                ...
                                <form>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="reference-relationship[]"
                                            required>
                                    </div>
                                </form>
