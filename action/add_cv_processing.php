...
// if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO working_history (resume_id, user_id,  position, company_name,  start_date, end_date, tasks) VALUES ";
    foreach ($work_histories as $work_history) {
        $sql .= "('$insert_id','$user_id','$work_history[job_name]', '$work_history[company_name]', '$work_history[start_date]', '$work_history[end_date]', '$work_history[working_description]'),";
    }
    $sql = rtrim($sql, ",");
    mysqli_query($conn, $sql);
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
