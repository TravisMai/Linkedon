            ...
            <div class="social-nav">
                <nav role="navigation">
                    <ul class="nav justify-content-center">
                        ...
                        <li class="nav-item"><a class="nav-link" href="mailto:emches1976@gmail.com" title="Gmail"><i
                                    class="fa fa-envelope"></i><span class="menu-title sr-only">Gmail</span></a></li>
                        <li class="nav-item"><a class="nav-link"
                                href="https://www.linkedin.com/in/ngh%C4%A9a-mai-10654824b/" title="LinkedIn"><i
                                    class="fab fa-linkedin"></i><span class="menu-title sr-only">LinkedIn</span></a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="https://github.com/TravisMai" title="Github"><i
